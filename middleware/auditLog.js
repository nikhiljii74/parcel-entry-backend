...
const trackAuditLog = require('../middleware/auditLog');  


router.post("/", trackAuditLog, async (req, res) => {
  try {
...
router.delete('/:id', trackAuditLog, async (req, res) => {
  try {
...
router.put('/:id', trackAuditLog, async (req, res) => {
  try {
